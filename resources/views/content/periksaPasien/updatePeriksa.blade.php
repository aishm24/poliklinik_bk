...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Update Periksa Pasien</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                    ...
                    <form action="{{route('update.periksa', ['id' => $periksa->id])}}" method="post">
                      ...
                      <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="nama_pasien" id="inputName" placeholder="Nama pasien" disabled required value="{{$periksa->daftarPoli->pasien->nama}}">
                          </div>
                        @error('nama_pasien')
                          ...
                          <select class="select2" name="obat[]" multiple="multiple" data-placeholder="Pilih Obat" style="width: 100%;">
                              @foreach ($obat as $item)
                                  <option 
                                      ...
                                      {{ in_array($item->id, $selectedObatIds) ? 'selected' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="biaya_periksa" id="inputTotalBiaya" placeholder="Total Biaya" readonly value="{{$periksa->biaya_periksa}}">
                          </div>
                        @error('biaya_periksa')
                              <small class="text-danger">{{ $message }}</small>
                        @enderror
